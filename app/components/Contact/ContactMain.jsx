      ...
      <Conatiner>
        <div className="font-[sans-serif] max-w-6xl mx-auto relative bg-white rounded-lg py-6">
          <div className="grid lg:grid-cols-3 items-center">
            <div className="grid sm:grid-cols-2 gap-4 z-20 relative   max-lg:px-4">
            ...
            <div className="lg:col-span-2 bg-primary bg-opacity-30 rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
              ...
              <form onSubmit={handleContactSubmit}>
                <div className="max-w-md mx-auto space-y-3">
                  ...
                  <button
                    disabled={loading}
                    type="submit"
                    className="text-white w-full relative bg-primary hover:bg-opacity-80 font-semibold rounded-lg text-sm px-6 py-3 !mt-6"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16px"
